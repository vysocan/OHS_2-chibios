...
/*
 * Setup for Open Home Security STM32F4x7-2.0.4 board.
 */

/*
 * Board identifier.
 */
#define BOARD_OHS_204
#define BOARD_NAME                  "Open Home Security STM32F4x7-2.0.4"
...
#define GPIOE_DIN_BOX               8U
#define GPIOE_PIN9                  9U
#define GPIOE_PIN10                 10U
#define GPIOE_ETH_RESET             11U
...
#define LINE_RX3                    PAL_LINE(GPIOD, 8U)
#define LINE_TX3                    PAL_LINE(GPIOD, 9U)
...
#define LINE_DIN_BOX                PAL_LINE(GPIOE, 8U)
#define LINE_ETH_RESET              PAL_LINE(GPIOE, 11U)
...
#define VAL_GPIOD_AFRH              (PIN_AFIO_AF(GPIOD_RX3, 7U) |           \
                                     PIN_AFIO_AF(GPIOD_TX3, 7U) |           \
 ...
 * PE8  - DIN_BOX                   (input floating).
 * PE9  - PIN9                      (input floating).
 * PE10 - PIN10                     (input floating).
 * PE11 - ETH_RESET                 (output pushpull maximum).
...
#define VAL_GPIOE_AFRH              (PIN_AFIO_AF(GPIOE_DIN_BOX, 0U) |       \
